...
public class honeygaincase038_MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.honeygaincase038_main);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(honeygaincase038_MainActivity.this, honeygaincase038_MainActivity2.class);
                startActivity(i);
            }
        });
